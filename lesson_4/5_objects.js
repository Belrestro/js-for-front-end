...
// це часто буває важкувато проходити все це щоб тільки пройтись по об'єкту
// для цього існують спеціальні види циклів які значно спрощують вам роботу

for (const key in object) { // for in цикл для того щоб пройтись по ключам об'єкта
  console.log(key);
  console.log(object[key]);
}

for (const value of object) { // for ok цикл для того щоб пройтись по властивостям об'єкта
